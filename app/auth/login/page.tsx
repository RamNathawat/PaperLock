  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-sm p-8">
        ...
        <p className="text-gray-500 text-sm mb-8">Oklahoma RPCD Disclosure App</p>

        <button
          onClick={handleGoogle}
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition mb-6 disabled:opacity-50"
        >
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4" noValidate>
          ...
          {error && <p role="alert" aria-live="polite" className="text-red-600 text-xs">{error}</p>}
        ...
        <button
          ...
          className="w-full mt-3 border border-gray-300 rounded-lg py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition disabled:opacity-50"
        >
          Send magic link
        </button>
