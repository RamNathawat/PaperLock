...
export async function PATCH(
  ...
  const mergedFormData = isSeller2SessionWrite
    ? {
        ...existingFormData,
        signatures: {
  ...
  debugFloodSnapshot("existing-before-update", existingFormData);
  debugFloodSnapshot("incoming-request", incomingFormData);
  debugFloodSnapshot(
    isSeller2SessionWrite ? "merged-seller2-write" : "merged-standard-write",
    mergedFormData
  );
