  ...
  return (
    <div className="space-y-5">
      ...
      <FieldBox
        ...
        tip="FEMA designates flood zones based on risk. Properties in a 100-year flood zone typically require flood insurance. Check FEMA's Flood Map Service if unsure."
      >
        <div className="flex flex-wrap gap-4">
        ...
        {/* Sub-questions only when flood zone = Yes */}
        {showFloodDetails && (
      ...
      {/*
        Q5 and Q6 are ALWAYS shown — they are permanent questions on the form.
        The Oklahoma RPCD form has them on every disclosure regardless of flood zone status.
      */}
      <FieldBox
        errorPath="page2Flood.q5"
        label="Q5. Are you aware of any flood insurance requirements concerning the property?"
        tip="Lenders typically require flood insurance for properties in high-risk flood zones. Even if not required, existing coverage may transfer to the buyer."
      >
        <div className="flex flex-wrap gap-4">
          {["Yes", "No"].map((opt, i) => (
            <label key={opt} className="flex items-center gap-2 text-sm text-gray-600">
