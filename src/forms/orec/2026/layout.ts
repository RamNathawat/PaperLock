...
export const PROPERTY_IDENTIFIER = { page: 0, x: 138, y: 765, fontSize: 10 };
...
export const PAGE4_TEXT_FIELDS = {
  q41AmountOfDues: { x: 130, y: 652.5 }, q41SpecialAssessment: { x: 280, y: 652.5 },
  q41IfYesAmount: { x: 180, y: 580.5 }, q41ManagerName: { x: 300, y: 580.5 },
  q41Phone: { x: 305, y: 556 }, q46Amount: { x: 152, y: 433 },
  q46PaidTo: { x: 265, y: 433 }, q47IfOtherExplain: { x: 125, y: 345 },
  q47InitialMembership: { x: 156, y: 321 }, q47AnnualMembership: { x: 335, y: 321 },
};
